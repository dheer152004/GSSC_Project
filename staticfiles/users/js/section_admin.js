(function($) {
    $(document).ready(function () {
        ...
        $school.change(function () {
            ...
            if (schoolId) {
                fetchAndPopulate('/users/get-departments/', { school_id: schoolId }, $department);
            }
        });
        ...
        $department.change(function () {
            ...
            if (departmentId) {
                fetchAndPopulate('/users/get-mentors/', { department_id: departmentId }, $mentor, function (item) {
                    return `${item.first_name} ${item.last_name} (${item.employee_id})`;
                });
            }
        });
    });
